...
pub enum AndroidKeyringError {
    ...
    JavaExceptionThrow,
    #[error("Android SharedPreferences rejected the durable credential commit")]
    SharedPreferencesCommitRejected,
    #[error("{1}")]
...
impl From<AndroidKeyringError> for keyring_core::Error {
    fn from(value: AndroidKeyringError) -> Self {
        match value {
            ...
            e @ AndroidKeyringError::SharedPreferencesCommitRejected => {
                keyring_core::Error::PlatformFailure(Box::new(e))
            }
