/**
 * station#1225 (offline slice 3): the ONE shared "refresh this chat's
 ...
 *
 * station#1225 review (MEDIUM fix): `queryClient` is threaded through as an
 ...
 * inline code also had (see the file-header MEDIUM-fix note).
 */
export async function rehydrateChatSession(
  ...
  // station#1311 review: this path is BOTH the mount-time rehydrate AND the
