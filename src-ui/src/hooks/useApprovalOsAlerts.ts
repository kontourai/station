 ...
 *
 * station#1912, from live use: a device pairing request expires in five
 ...
 * exists for — never appears in it (caught in review before shipping).
 *
 ...
 *   that case needs the host-side watch (#917), which stays dormant.
