 ...
 *
 * station#1424 review fix (M1): pins the actual reported defect end-to-end
...
describe('MessageBubble temporal-drift regression (station#1424 M1)', () => {
  test("a persisted (non-streaming) assistant row never shows an engine chip derived from the agent's current live binding", () => {
    ...
    // NOT a blanket "no .engine-chip ever" assertion (station#1424 review
    // round 3, NEW-2): a correct #1410 turn-envelope implementation is
