 ...
 * top of the project page, from a single derivation (archive#3202).
 *
 ...
 * what that costs.
 *
 * BADGE SEMANTICS CHANGED HERE, DELIBERATELY. Until archive#3202 the badge folded
 * the conversation INVENTORY and counted, among other things, `(completed |
 * failed) && !acknowledged` — "you have not looked at the result"
 * (archive#1781). Live work does not include a finished run, so that leg is no
