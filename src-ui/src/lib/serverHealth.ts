...
/**
 * station#3297 — the single derivation both probes below use for a non-OK
...
export async function checkServerHealthDetailed(
  ...
  try {
    ...
    // station#3297: both probes now share one derivation
    ...
    // station#1713: a desktop native-transport invoke-layer refusal (e.g.
...
export async function probeServerConnection(
  ...
  try {
    ...
    // station#3297: this line was the defect the issue was filed about. The
    ...
    // station#1713: same invoke-layer recognition as `checkServerHealthDetailed`
