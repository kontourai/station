 ...
 * (`station-start-first-run-tour`, plus its own chapter state), and (station#3089)
 ...
 *
 * WHY ONE BOUNDARY AND NOT MORE (station#2652 review H1). Each `lazy(() =>
 ...
 * measured the same way (station#3089, ~176 gzip bytes against a ceiling with
