...
The first-run Engines chapter shows the same detected local Engine set. Selecting one there
explicitly connects the Engine and creates its External agent together; detection itself remains
read-only until that action.
