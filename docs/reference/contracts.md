...
| `@kontourai/station-contracts/relay-enrollment` | Fresh relay-only account enrollment challenge/login proof bindings; a pending identity only, with no Device, continuation, Project or operator authority |
