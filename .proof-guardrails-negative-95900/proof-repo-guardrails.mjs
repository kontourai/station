...
import { collectCiWorkflowGovernanceFindings } from '../scripts/ci-workflow-governance.mjs';
import { gitLsFiles } from '../scripts/lib/ratchet-utils.mjs';
import {
  collectPaneHostCompositionFindings,
  createRequiredSourceReader,
} from '../scripts/repo-guardrail-source.mjs';
import { collectRouteErrorEgressFindings } from '../scripts/route-error-egress-gate.mjs';
...
const packageJson = readRequiredJson('../package.json.retired');
...
const baseline = readRequiredJson('../scripts/proof-repo-guardrails-baseline.json');
