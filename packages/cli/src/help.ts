...
const VERBS: Record<string, VerbSpec> = {
  ...
  environment: {
    ...
    usage: [
      ...
      'station environment access approve [<request-id>|--latest] [--force] [--bind-person] [--api-base=<loopback-url>|--station=<name>]',
      'station environment access deny [<request-id>|--latest] [--force] [--api-base=<loopback-url>|--station=<name>]',
