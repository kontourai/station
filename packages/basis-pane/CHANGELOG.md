...
- 3af06aa: Expose a pure Whole Task collection view shared by native and bounded portable
  delivery, retaining Surface-owned per-answer semantics and full native browsing.
- 451e536: Add the static read-only Whole Task Basis MCP App resource and bounded host
  continuation contract while preserving Surface-owned answer semantics.
