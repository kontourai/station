...
// The two real-tree cases of this cross-check live in
// content-integrity-gate.scan.test.ts (#2176), where the `repo-scans`
// pull-request job runs them; this is the fixture-repo control they rely on.
