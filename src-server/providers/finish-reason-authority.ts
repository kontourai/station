 ...
 *   `listSessionProjectionEventsForThreads` mirror, archive#3485): a
 ...
 *
 * archive#3509 fix round MEDIUM 2 (recorded when this set lived inside the
 ...
 * decision. Not hypothetical: archive#3545's leading fix candidate WAS
 * "accept `'other'`" — considered and rejected in favor of the producer fix
 * (archive#3545 itself describes `'other'` as meaning "we do not know," and
 * that description still holds today). archive#3587 then added `'other'` to
